...
\begin{enumerate}
    ...
    \item An infinitely long dielectric cylinder of radius $R$ is polarized as $\mathbf{P}(r) = \frac{a}{r}\,\hat{r}$ for $0 < r \le R$, where $a$ is a constant.


    \begin{enumerate}
        \item Find the bound volume charge density $\rho_b$.
        \item Find the bound surface charge density $\sigma_b$ at $r = R$.
        \item Compute the total bound charge per unit length.
        \item Explain why the result is surprising (or not).
        \item How can there be surface charge if the divergence is zero everywhere?
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Determine whether the system is overall neutral.
